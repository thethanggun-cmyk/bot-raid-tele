...
app = Flask('')
@app.route('/')
def home(): return "STATUS: RAIDING SAFE - 4S DELAY"
...
MESSAGES = [
    ...
    "Mày không đủ tư cách để bố mày phí lời, thằng vô học!",
    ...
    try:
        ...
        while True:
            try:
                ...
                # Ký tự tàng hình để tránh trùng lặp tin nhắn
                hidden = "\u200b" * random.randint(1, 10)
                
                # Cấu trúc: # Chữ To + Tag cuối + Ký tự tàng hình
                content = f"# {msg} \n<@{t_id}>{hidden}"
                ...
                print(f"Lỗi gửi: {e}")
                await asyncio.sleep(5) # Nếu lỗi thì nghỉ lâu hơn tí
            
            # Nghỉ đúng 4 giây như mày yêu cầu
