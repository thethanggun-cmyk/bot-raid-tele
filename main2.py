    ...
    try:
        ...
        while True:
            try:
                ...
                # Tăng dải ký tự tàng hình từ 1 đến 30 để tin nhắn luôn khác biệt
                hidden_suffix = "\u200b" * random.randint(1, 30)
                ...
                if e.status == 429: # Bị Rate Limit
                    print("!!! DÍNH RATE LIMIT - NGHỈ 30S !!!")
            ...
            # NGHỈ 4 GIÂY + NGẪU NHIÊN 0.1 ĐẾN 1 GIÂY (Né quét bot)
            delay = 4.0 + random.uniform(0.1, 1.0)
